...
import com.desiemoji.keyboard.common.ext.*
import com.desiemoji.keyboard.ui.keyboard.main.ItemMainKeyboard.Companion.KEYCODE_DELETE
import com.desiemoji.keyboard.ui.keyboard.main.ItemMainKeyboard.Companion.KEYCODE_EMOJI
import com.desiemoji.keyboard.ui.keyboard.main.ItemMainKeyboard.Companion.KEYCODE_ENTER
import com.desiemoji.keyboard.ui.keyboard.main.ItemMainKeyboard.Companion.KEYCODE_MODE_CHANGE
import com.desiemoji.keyboard.ui.keyboard.main.ItemMainKeyboard.Companion.KEYCODE_SHIFT
import com.desiemoji.keyboard.ui.keyboard.main.ItemMainKeyboard.Companion.KEYCODE_SPACE
import com.desiemoji.keyboard.ui.keyboard.main.ItemMainKeyboard.Companion.MAX_KEYS_PER_MINI_ROW
        ...
        if (popupKeyboardId != 0) {
            ...
            if (mMiniKeyboardContainer == null) {
                ...
                mMiniKeyboard!!.mOnKeyboardActionListener = object : OnKeyboardActionListener {
                    ...
                    override fun onHideKeyboardOnly() {
...
//                mMiniKeyboardContainer!!.measuredWidth - (popupKey.popupCharacters!!.length / 2) * popupKey.width
            val widthToUse =
                mMiniKeyboardContainer!!.measuredWidth - (popupKey.popupCharacters!!.length) * popupKey.width
            ...
            when (action) {
                MotionEvent.ACTION_MOVE -> {
                    if (mMiniKeyboard != null) {
                        ...
                        if (selectedKeyIndex != mMiniKeyboardSelectedKeyIndex) {
                            ...
                            mMiniKeyboardSelectedKeyIndex = selectedKeyIndex
                            Log.i("onTouchEvent","mMiniKeyboardSelectedKeyIndex "+mMiniKeyboardSelectedKeyIndex)
                            mMiniKeyboard!!.invalidateAllKeys()
                        }
                ...
                MotionEvent.ACTION_UP, MotionEvent.ACTION_CANCEL -> {
                    mMiniKeyboard?.mKeys?.firstOrNull { it.focused }?.apply {
                        mOnKeyboardActionListener!!.onKey(code)
//                        mOnKeyboardActionListener!!.onText(mMiniKeyboard?.mKeys?.get(mMiniKeyboardSelectedKeyIndex)?.label.toString())
                         Log.i("onTouchEvent","MotionEvent.ACTION_UP, MotionEvent.ACTION_CANCEL 1 -> "+code)
                        Log.i("onTouchEvent","MotionEvent.ACTION_UP, MotionEvent.ACTION_CANCEL 2 -> "+mMiniKeyboard?.mKeys?.size)
                    }
