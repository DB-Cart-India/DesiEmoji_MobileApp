...
import com.desiemoji.keyboard.di.hilt.DatabaseModule_ProvideAutoTextDaoFactory;
import com.desiemoji.keyboard.di.hilt.DatabaseModule_ProvideDatabaseFactory;
...
import com.desiemoji.keyboard.ui.autotext.AutoTextActivity;
import com.desiemoji.keyboard.ui.autotext.AutoTextDetailActivity;
import com.desiemoji.keyboard.ui.autotext.AutoTextEditorActivity;
import com.desiemoji.keyboard.ui.autotext.AutoTextViewModel;
import com.desiemoji.keyboard.ui.autotext.AutoTextViewModel_HiltModules_KeyModule_ProvideFactory;
import com.desiemoji.keyboard.ui.detail.DetailActivity;
import com.desiemoji.keyboard.ui.detail.DetailViewModel;
import com.desiemoji.keyboard.ui.detail.DetailViewModel_HiltModules_KeyModule_ProvideFactory;
import com.desiemoji.keyboard.ui.main.MainActivity;
import com.desiemoji.keyboard.ui.main.MainFragment;
import com.desiemoji.keyboard.ui.main.MainViewModel;
import com.desiemoji.keyboard.ui.main.MainViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMainApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MainApp_HiltComponents.ActivityC {
    ...
    @Override
    public void injectAutoTextActivity(AutoTextActivity autoTextActivity) {
    }

    @Override
    public void injectAutoTextDetailActivity(AutoTextDetailActivity autoTextDetailActivity) {
    }

    @Override
    public void injectAutoTextEditorActivity(AutoTextEditorActivity autoTextEditorActivity) {
    }
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(3).add(AutoTextViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(DetailViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(MainViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends MainApp_HiltComponents.ViewModelC {
    ...
    private Provider<AutoTextViewModel> autoTextViewModelProvider;
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.autoTextViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(3).put("com.desiemoji.keyboard.ui.autotext.AutoTextViewModel", ((Provider) autoTextViewModelProvider)).put("com.desiemoji.keyboard.ui.detail.DetailViewModel", ((Provider) detailViewModelProvider)).put("com.desiemoji.keyboard.ui.main.MainViewModel", ((Provider) mainViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.desiemoji.keyboard.ui.autotext.AutoTextViewModel 
          return (T) new AutoTextViewModel(singletonCImpl.autoTextRepositoryImpl());

          case 1: // com.desiemoji.keyboard.ui.detail.DetailViewModel 
          return (T) new DetailViewModel(singletonCImpl.autoTextRepositoryImpl());

          case 2: // com.desiemoji.keyboard.ui.main.MainViewModel 
          return (T) new MainViewModel(singletonCImpl.autoTextRepositoryImpl());
  ...
  private static final class SingletonCImpl extends MainApp_HiltComponents.SingletonC {
    ...
    private AutoTextDao autoTextDao() {
      return DatabaseModule_ProvideAutoTextDaoFactory.provideAutoTextDao(provideDatabaseProvider.get());
    }

    private AutoTextRepositoryImpl autoTextRepositoryImpl() {
      return new AutoTextRepositoryImpl(autoTextDao());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.desiemoji.keyboard.data.local.db.AppDatabase 
