...
import com.desiemoji.keyboard.common.ext.getProperBackgroundColor
import com.desiemoji.keyboard.common.ext.getProperTextColor
import com.desiemoji.keyboard.databinding.KeyboardImeBinding
...
//        binding?.keyboardAutotext?.setupData()
    ...
    private fun initCurrentInputConnection() {
        binding?.apply {
//            keyboardAutotext.setInputConnection(currentInputConnection,currentInputEditorInfo)
//            keyboardNews.setInputConnection(currentInputConnection,currentInputEditorInfo)
//            keyboardMoview.setInputConnection(currentInputConnection,currentInputEditorInfo)
//            keyboardWebview.setInputConnection(currentInputConnection,currentInputEditorInfo)
//            keyboardForm.setInputConnection(currentInputConnection,currentInputEditorInfo)

            keyboardEmoji.setInputConnection(currentInputConnection,currentInputEditorInfo)
        }
    }
    ...
    private fun onKeyExt(code: Int, inputConnection: InputConnection) {
        ...
        when (code) {
            ...
            ItemMainKeyboard.KEYCODE_EMOJI -> {
                ...
                hideMainKeyboard()
                binding?.keyboardEmoji?.binding?.edSearch?.showKeyboardExt()
